...
export const Founders: React.FC = () => {
  ...
  const founder = {
      ...
      image: "https://images.unsplash.com/photo-1556157382-97eda2d62296?auto=format&fit=crop&q=80&w=1000", // Generic professional portrait
  };
            ...
            <div className="w-full lg:w-1/2 relative">
                <div className="relative aspect-[3/4] overflow-hidden rounded-sm bg-gray-100">
                    ...
                    <div className="absolute bottom-0 left-0 p-8">
                         <h3 className="text-white text-9xl font-display font-bold opacity-20 leading-none -ml-4 -mb-4">LEAD</h3>
                    </div>
                </div>
